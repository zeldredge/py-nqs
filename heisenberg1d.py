...
class Heisenberg1d:
    ...
    def __init__(self,nspins,jz,pbc = True): #Input args are number of spins, Jz coupling, and whether periodic boundary conditions apply
        self.nspins = nspins
        self.jz = jz
        self.pbc = pbc
        self.minflips = 2
    ...
    def FindConn(self,state): #Given a state, find all states connected to it by this Hamiltonian
        ...
        return mel,flipsh #So what we have here is a vector of all matrix elements, and then a vector which tells you which states to flip to get that connection
